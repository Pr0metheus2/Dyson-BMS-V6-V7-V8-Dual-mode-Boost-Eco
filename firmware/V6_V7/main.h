...
extern uint32_t mincell_internal_resistence_max; //record highest recorded internal resistence
...
extern uint16_t MAX_CHARGE_CELL_VOLTAGE_mV;       //Charging will stop when max cell voltage goes above this value. Dynamik Value, either MAX_CHARGE_CELL_VOLTAGE_ECO_mV or MAX_CHARGE_CELL_VOLTAGE_BOOST_mV
